...
local function ConvertLegacyClasses()
    for name, class in SortedPairs(CLASSES) do
        ...
        Dev(
            1,
            "[TTTC] LEGACY CLASS Converted '"
                .. name
                .. "' Class (index: "
                .. class.index
                .. "). Please consider reworking this class!"
        )
    end
end
...
if SERVER then
    ...
    hook.Add("PlayerAuthed", "TTTCLegacyClassesSync", function(ply)
        Dev(1, "[TTTC] Sending LEGACY CLASSES list to " .. ply:Nick() .. "...")
    ...
    net.ReceiveStream("TTTCSyncLegacyClasses", function(streamData)
        Dev(1, "[TTTC] Received LEGACY CLASSES list from server! Updating...")
